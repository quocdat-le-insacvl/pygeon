...
class Menu():
        ...
        for layer in Map:
            ...
            for tile in layer:
                ...
                if Map[i][j] != None:
                    ...
                    if Map[i][j] == '3' : 
                        display.blit(floor_2,(x-center_x,y-center_y))
                    if Map[i][j] == '5' :
    ...
    def Credit(self):
        ...
        while running:
            ...
            self.draw_text("Center_x : %i, Center_y : %i , player_x : %i,player_y : %i"%(center_x,center_y,player_rect.x,player_rect.y),ColderWeather,WHITE,screen,100,100)
            ...
            if afficher_inv: self.shop_print(self.perso,self.perso)
