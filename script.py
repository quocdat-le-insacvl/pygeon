...
sorcerer = Sorcerer(inventaire=pack,size=(300,300), name= "",n_case = 59)

sorcerer_2 = Fighter(inventaire=pack,size=(300,300), name = "",n_case = 65)
sorcerer_3 = Rogue(inventaire=pack,size=(300,300), name= "", n_case = 51)
sorcerer_3.level = 1
